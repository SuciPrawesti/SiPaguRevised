...
<div class="no-print" style="max-width:800px;margin:10px auto;display:flex;gap:8px;">
    ...
    <a href="<?= BASE_URL ?>koordinator/upload_data/hitung_honor.php" style="padding:8px 20px;background:#6c757d;color:white;border-radius:4px;text-decoration:none;font-size:13px;">
        ← Kembali
    </a>
