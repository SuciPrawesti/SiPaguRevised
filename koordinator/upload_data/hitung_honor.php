            ...
            <div class="col-12 col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="<?= BASE_URL ?>koordinator/upload_data/pertemuan_dosen.php" class="btn btn-outline-primary btn-sm btn-block">
                            ...
                            <table class="table table-striped table-sm">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= BASE_URL ?>koordinator/upload_data/cetak_slip_honor.php?id_thd=<?= $h['id_thd'] ?>" class="btn btn-info btn-sm" title="Cetak Slip" target="_blank"><i class="fas fa-print"></i></a>
                                        <?php elseif ($h['status']==='dibayar'): ?>
                                        <a href="<?= BASE_URL ?>koordinator/upload_data/cetak_slip_honor.php?id_thd=<?= $h['id_thd'] ?>" class="btn btn-secondary btn-sm" title="Cetak Slip" target="_blank"><i class="fas fa-print"></i></a>
