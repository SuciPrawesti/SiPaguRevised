...
$q_honor = mysqli_query($koneksi, "
    SELECT thd.bulan, thd.periode_awal, thd.periode_akhir, thd.jml_tm, thd.sks_tempuh, thd.status, thd.total_honor,
                                ...
                                <div class="activity-item">
                                    ...
                                    <div class="activity-content flex-grow-1">
                                        ...
                                        <small class="text-muted">
                                            ...
                                            &nbsp;·&nbsp; <span class="badge badge-<?= (['pending'=>'warning','dibayar'=>'success','digabung'=>'info'][$row['status']] ?? 'secondary') ?>"><?= ucfirst($row['status'] ?? 'pending') ?></span>
                                        </small>
                                    </div>
                                </div>
                                <?php endwhile; ?>
