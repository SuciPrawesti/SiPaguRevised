        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="<?= BASE_URL ?>admin/upload_data/pertemuan_dosen.php" class="btn btn-outline-primary btn-sm mr-1">
                        <i class="fas fa-plus"></i> Input Pertemuan
                    </a>
                    <a href="<?= BASE_URL ?>admin/upload_data/hitung_honor.php" class="btn btn-primary btn-sm">
                    ...
                    <table class="table table-striped" id="table-1">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= BASE_URL ?>admin/upload_data/cetak_slip_honor.php?id_thd=<?= $row['id_thd'] ?>" class="btn btn-info btn-sm" target="_blank" title="Cetak Slip"><i class="fas fa-print"></i></a>
                                <?php endif; ?>
